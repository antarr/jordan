...
RSpec.describe SessionsController, 'Unified Login', type: :controller do
  ...
  describe 'POST #create with unified login form' do
    context 'email login' do
      let(:email_user) { create(:user, :email_user, :verified, password: 'ValidPass123!', password_confirmation: 'ValidPass123!') }
      ...
      it 'rejects unverified email user' do
        unverified_user = create(:user, :email_user, :unverified, password: 'ValidPass123!', password_confirmation: 'ValidPass123!')
