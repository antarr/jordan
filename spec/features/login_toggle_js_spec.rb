...
RSpec.feature 'Login Toggle JavaScript', type: :feature, js: true do
  scenario 'User can toggle between forms using JavaScript', js: true do
  ...
  scenario 'Switching forms focuses the first field', js: true do
    visit new_session_path
